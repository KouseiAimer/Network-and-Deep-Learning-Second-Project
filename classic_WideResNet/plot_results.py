"""Plot and summarize WideResNet training logs."""
...
def plot_history(history_path: Path, output_path: Path, title: str = "WideResNet on CIFAR-10") -> None:
    import matplotlib
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Plot WideResNet training curves")
    ...
    parser.add_argument("--title", type=str, default="WRN-28-10 on CIFAR-10")
