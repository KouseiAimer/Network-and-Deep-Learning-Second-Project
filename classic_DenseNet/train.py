...
from model import count_parameters, describe_model, densenet_bc
...
class Cutout:
    """Randomly mask one square region from a tensor image."""
...
def parse_args() -> argparse.Namespace:
    ...
    default_name = "densenet_bc_100_24"

    parser = argparse.ArgumentParser(description="DenseNet-BC for CIFAR-10")
...
def main() -> None:
    ...
    print(f"Model: DenseNet-BC-{args.depth}-{args.growth_rate}")
    ...
    title = f"DenseNet-BC-{args.depth}-{args.growth_rate} on CIFAR-10"
