"""Train the final improved SE-DenseNet on CIFAR-10."""
...
def parse_args() -> argparse.Namespace:
    ...
    default_output = exp_root / "final_result" / "final_se_densenet"

    parser = argparse.ArgumentParser(description="Final improved SE-DenseNet for CIFAR-10")
