"""Plot and summarize MyDenseNet training logs."""
...
def plot_history(history_path: Path, output_path: Path, title: str = "MyDenseNet on CIFAR-10") -> None:
    import matplotlib
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Plot MyDenseNet training curves")
    ...
    parser.add_argument("--title", type=str, default="Final SE-DenseNet on CIFAR-10")
